...
class Config:
    ...
    # Data paths
    DATA_ROOT: str = "/home/fluuvys/ICPR Competition/data/train" # Path to data
    TEST_DATA_ROOT: str = "/home/fluuvys/ICPR Competition/data/TKzFBtn7-test-blind" # Path to test set
    VAL_SPLIT_FILE: str = "data/val_tracks.json"
    SUBMISSION_FILE: str = "submission.txt"
    
    IMG_HEIGHT: int = 32 #32
    IMG_WIDTH: int = 128 # 128
